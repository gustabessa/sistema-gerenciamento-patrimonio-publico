 ...
 * @author gusta
 */
public class ExportAM {

    private static int count = 0;
    public String RESULT
            = "C:\\Users\\gusta\\Documents\\Trabalho 02 (Final)\\export\\exportAM";

    public ExportAM(List<Item> Itens, Ambiente A) {
        count++;
        RESULT = RESULT + count + A.getCampus().getAbreviacao() + "." + A.getDescricao() + ".pdf";
        try {
            this.createPdf(RESULT, Itens, A);
        } catch (Exception e) {
        }

    }

    public void createPdf(String filename, List<Item> Itens, Ambiente A)
     ...
     */
    public static PdfPTable createTable1(List<Item> Itens, Ambiente A) throws DocumentException {
        double total = 0;
